...
<head>
	...
	<?php if ( !empty($data['wm_favicon_upload']) && $data['wm_favicon_enabled'] == "0" ) { ?><link rel="icon" type="<?=( (0 < strrpos($data['wm_favicon_upload'], '.png') ) ? 'image/png': ( (0 < strrpos($data['wm_favicon_upload'], '.gif') ) ? 'image/gif' : 'image/x-icon' ) )?>" href="<?php echo $data['wm_favicon_upload'];?>"><?php } ?>
	...
	<?php } ?>	
	<script src="<?php echo get_stylesheet_directory_uri();?>/js/recentblog.js" type="text/javascript" ></script>
	<link type="text/css" rel="stylesheet" href="https://fast.fonts.net/cssapi/7f0a1d7a-4d83-4c9d-9a34-900a2a4ac30d.css"/>
</head>
<?php
...
<!--=============  Main Content Start =============-->    
   <div class="sliderInfoContainer">
      	<div class="slider-info <?php if ( $data['wm_slider_placement'] == "" || $data['wm_slider_placement'] == "0" ) { ?><? } else { ?>slider-top<?php } ?>">    
