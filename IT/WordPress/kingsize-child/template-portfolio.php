							...
							<div class="<?php echo $div_layout;?>">	
								<div class="row">
									<div class="twelve columns">
										...
										<h2 class="post_title"><?php if ( $data['wm_show_portfolio_title'] == "0" || $data['wm_show_portfolio_title'] == "") {?><a href="<?php echo $permalink; ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a><?php } else { ?><!-- No Titles --><?php } ?></h2>
