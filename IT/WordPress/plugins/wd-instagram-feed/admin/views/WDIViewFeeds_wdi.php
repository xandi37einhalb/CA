  ...
  public function display() {
    ...
    <div style="clear: both; float: left; width: 99%;">
      <div style="float: left; font-size: 14px; font-weight: bold;">
        <?php _e('This section allows you to create, edit and delete Feeds.', "wdi"); ?>
        <a style="color: #ff4444; text-decoration: none;" target="_blank" href="https://web-dorado.com/wordpress-instagram-feed-wd/creating-feeds.html"><?php _e('Read More in User Manual',"wdi"); ?></a>
      </div>
    </div>
...
public function getFormElements($current_id=''){
    ...
    $elements = array(
      ...
      'show_likes' => array('name'=>'show_likes','title'=>__('Show Likes',"wdi"),'type'=>'checkbox','tooltip'=>'','attr'=>array(array('name'=>'tab','value'=>'feed_settings'),array('name'=>'section','value'=>'thumbnails,masonry,blog_style,image_browser'))),
      'show_description' => array('name'=>'show_description','title'=>__('Show Description',"wdi"),'type'=>'checkbox','tooltip'=>'','attr'=>array(array('name'=>'tab','value'=>'feed_settings'),array('name'=>'section','value'=>'thumbnails,masonry,blog_style,image_browser'))),
      'show_comments' => array('name'=>'show_comments','title'=>__('Show Comments',"wdi"),'type'=>'checkbox','tooltip'=>'','attr'=>array(array('name'=>'tab','value'=>'feed_settings'),array('name'=>'section','value'=>'thumbnails,masonry,blog_style,image_browser'))),
      'show_username_on_thumb' => array('name'=>'show_username_on_thumb','title'=>__('Show Username On Image Thumb',"wdi"),'type'=>'checkbox','tooltip'=>'','attr'=>array(array('name'=>'tab','value'=>'feed_settings'),array('name'=>'section','value'=>'thumbnails,masonry'))),
      ...
      'popup_enable_filmstrip' => array('name'=>'popup_enable_filmstrip','title'=>__('Enable filmstrip in lightbox',"wdi"),'type'=>'radio','valid_options'=>array('1'=>__('Yes',"wdi"),'0'=>__('No',"wdi")),'hide_ids'=>array('0'=>'popup_filmstrip_height'),'tooltip'=>'','attr'=>array(array('name'=>'tab','value'=>'lightbox_settings'))),
      'popup_filmstrip_height' => array('name'=>'popup_filmstrip_height','title'=>__('Filmstrip size',"wdi"),'type'=>'input','input_type'=>'number','label'=>array('text'=>'px','place'=>'after'),'tooltip'=>'','attr'=>array(array('name'=>'class','value'=>'small_input'),array('name'=>'tab','value'=>'lightbox_settings'))),
      ...
      'popup_info_always_show' => array('name'=>'popup_info_always_show','title'=>__('Display info by default',"wdi"),'type'=>'radio','valid_options'=>array('1'=>__('Yes',"wdi"),'0'=>__('No',"wdi")),'tooltip'=>'','attr'=>array(array('name'=>'tab','value'=>'lightbox_settings'))),
      'popup_info_full_width' => array('name'=>'popup_info_full_width','title'=>__('Full width info',"wdi"),'type'=>'radio','valid_options'=>array('1'=>__('Yes',"wdi"),'0'=>__('No',"wdi")),'tooltip'=>'','attr'=>array(array('name'=>'tab','value'=>'lightbox_settings'))),
      ...
      'popup_enable_info' => array('name'=>'popup_enable_info','title'=>__('Enable info',"wdi"),'type'=>'radio','valid_options'=>array('1'=>'Yes','0'=>'No'),'tooltip'=>'','attr'=>array(array('name'=>'tab','value'=>'lightbox_settings'))),
      ...
      'popup_enable_comment' => array('name'=>'popup_enable_comment','title'=>__('Enable comments',"wdi"),'type'=>'radio','valid_options'=>array('1'=>__('Yes',"wdi"),'0'=>__('No',"wdi")),'tooltip'=>'','attr'=>array(array('name'=>'tab','value'=>'lightbox_settings'))),
      ...
      'popup_enable_share_buttons' => array('name'=>'popup_enable_share_buttons','title'=>__('Enable Share Buttons',"wdi"),'type'=>'radio','valid_options'=>array('1'=>__('Yes',"wdi"),'0'=>__('No',"wdi")),'tooltip'=>'','attr'=>array(array('name'=>'tab','value'=>'lightbox_settings'))),
...
public function generateForm($current_id = ''){
  ...
  ?>
    <div class="wrap">
    <div style="clear: both; float: left; width: 99%;padding-bottom:5px;">
      <div style="float: left; font-size: 14px; font-weight: bold;">
        <?php _e('Here You Can Change Feed Parameters', "wdi"); ?>
        <a style="color: #ff4444; text-decoration: none;font-size:14px;" target="_blank" href="https://web-dorado.com/wordpress-instagram-feed-wd/creating-feeds.html"><?php _e('Read More in User Manual',"wdi"); ?></a>
      </div>
    </div>
    <h2 style="font-size:20px;font-weight:200"><?php if($edit==true && isset($feed_row['feed_name'])){
          ...
          foreach ($elements as $element) {
            ...
            ?>
              ...
              <?php if( $element['name'] == 'conditional_filter_type' ): ?>
                ...
                <tr id="WDI_filter_source" style="display:block"><th scope="row"><a class="wdi_settings_link" href="#"><?php _e('Source of filtering','wdi'); ?></a><td>
                      <div><div><div><div tab="conditional_filters"></div></div></div></div>
                      <div id="wdi_filter_source"></div>
                       <p style="font-size:12px;"><?php _e('Please note that filters are being applied to maximum 330 image per load. This means that even if you have 25 images per load but only 20 images correspond to your filter then those 20 images will be displayed during the load.','wdi')?></p>
                </td></th></tr>
            ...
            <tr>
              <th scope="row"><a  href="#" <?php echo ($element['tooltip']!='' && isset($element['tooltip'])) ?  'class="wdi_tooltip" wdi-tooltip="'.$element['tooltip'].'"' :  'class="wdi_settings_link"'; ?> ><?php echo $element['title'];?></a></th>
                  ...
                  <?php $this->buildField($element,$feed_row);?>
                      ...
                      <?php if( $element['name'] == 'conditional_filter_type' ): ?>
                        </td></th></tr><tr style="display:block"><th scope="row"><a class="wdi_settings_link" href="#"><?php _e('Add Condition','wdi'); ?></a><td>
                        <div id="WDI_conditional_filters" class="selectoff">
                        <div><div><div tab="conditional_filters"></div></div></div>
                          ...
                          <div class="wdi_filter_ctrl_container">
                            <div class="wdi_filter_input">
                              <input id="wdi_filter_input" placeholder="<?php _e('Enter Your Condition Here...','wdi');?>" type="text">

                              <select name="wdi_filter_type" id="wdi_filter_type">
                                <option value="" disabled selected><?php _e('Condition Type','wdi')?></option>
                                <option value="username"><?php _e('Username','wdi')?></option>
                                <option value="hashtag"><?php _e('Hashtag','wdi')?></option>
                                <option value="mention"><?php _e('Mention','wdi')?></option>
                                <option value="description"><?php _e('Description','wdi')?></option>
                                <!-- <option value="location">Location Id</option> -->
                                <option value="url"><?php _e('Instagram Media Link','wdi')?></option>
                              </select>
                              <div id="wdi_add_filter" class="button"><?php _e('Add New Condition', "wdi"); ?></div>
                              <br><label style="font-size:12px" for="wdi_filter_input"><?php _e('Write your condition, select condition type and click on Add New Condition. You can add as many conditions as you want. You can add different condition types mixed together as well.','wdi')?></label>
                            </div>
                            
                          </div>
                          </td>
                          </th></tr>
                          <tr id='wdi_final_condition' style="display:block"><th scope="row"><a class="wdi_settings_link" href="#"><?php _e('Result','wdi'); ?></a><td>
                            <div><div><div><div tab="conditional_filters"></div></div></div></div>
                          <br><span style="font-size:13px;font-weight:bold;"><?php _e("Posts Which Meet Following Condition Would Be Shown")?></span>
                          <div id="wdi_filters_ui" class="wdi_filters_ui selectoff">
