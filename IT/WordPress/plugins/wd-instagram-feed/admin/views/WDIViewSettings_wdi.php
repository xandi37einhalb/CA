...
////////////////////////////////////////////////////////////////////////////////////////
	public function display(){
		...
		<div style="clear: both; float: left; width: 99%;">
	      <div style="float: left; font-size: 14px; font-weight: bold;padding-bottom:10px;padding-top:10px;">
	        <?php _e('This section allows you to set API parameters', "wdi"); ?>
	        <a style="color: #ff4444; text-decoration: none;" target="_blank" href="https://web-dorado.com/wordpress-instagram-feed-wd/installation-and-configuration/getting-access-token.html"><?php _e('Read More in User Manual.', "wdi"); ?></a>
	      </div>
	    </div>
