...
class WDIModelThemes_wdi {
  ...
  public function get_rows_data() {
    global $wpdb;
    $where = ((isset($_POST['search_value'])) ? 'WHERE theme_name LIKE "%' . esc_html(stripslashes($_POST['search_value'])) . '%"' : '');
  ...
  public function page_nav() {
    global $wpdb;
    $where = ((isset($_POST['search_value']) && (esc_html(stripslashes($_POST['search_value'])) != '')) ? 'WHERE theme_name LIKE "%' . esc_html(stripslashes($_POST['search_value'])) . '%"'  : '');
