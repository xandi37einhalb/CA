	...
	<div id="wdi_feed_<?php echo $wdi_feed_counter?>" class="wdi_feed_main_container">
		...
		<div class="wdi_feed_container">
			...
			<div class="wdi_feed_wrapper <?php echo 'wdi_col_'.$feed_row['number_of_columns']?>" wdi-res='<?php echo 'wdi_col_'.$feed_row['number_of_columns']?>'>
				<?php 
				for($i=0;$i<$feed_row['number_of_columns'];$i++){
					?><div class="wdi_masonry_column" wdi_mas_col="<?php echo $i?>"></div><?php				}
				?>
				<div class="clear"></div>
			</div>
...
public function pass_feed_data_to_js(){
	...
	$theme_row = $this->model->get_theme_row($feed_row['theme_id']);

	wp_localize_script("wdi_frontend", 'wdi_feed_'.$wdi_feed_counter,array('feed_row'=>$feed_row,'theme_row'=>$theme_row,'data'=>array(),'usersData'=>array(),'dataCount'=>0));
...
public function generate_feed_styles($feed_row){
	...
	<?php 
	//var_dump($feed_row['display_user_post_follow_number']);
	...
	#wdi_feed_<?php echo $wdi_feed_counter?> .wdi_masonry_column{
	...
	#wdi_feed_<?php echo $wdi_feed_counter?> .wdi_thumb_comments i,#wdi_feed_<?php echo $wdi_feed_counter?> .wdi_likes i{
		width: 100%;
	}
	#wdi_feed_<?php echo $wdi_feed_counter?> .wdi_photo_title {
	    text-overflow: ellipsis;
	    overflow: hidden;
	    white-space: <?php echo ($feed_row['show_full_description']==1) ? 'normal' : 'nowrap'?>;
	    width: 90%;
	    margin-left: 5%;
	    margin-right: 5%;
	...
	?>
	#wdi_feed_<?php echo $wdi_feed_counter?> .wdi_photo_overlay{
	...
	#wdi_feed_<?php echo $wdi_feed_counter?> .wdi_photo_overlay:hover i{
		color: <?php echo $style['th_overlay_hover_icon_color'];?>
	}
	#wdi_feed_<?php echo $wdi_feed_counter?> .wdi_photo_img img{
		transition: all 0.5s ease;
	}
	<?php
	...
	?>
	#wdi_feed_<?php echo $wdi_feed_counter?> .wdi_photo_img:hover img{
	...
	#wdi_feed_<?php echo $wdi_feed_counter?>  .wdi_media_user{
	  position: absolute;
	  bottom: 0;
	  right: 0;
