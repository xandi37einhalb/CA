...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> <?php hybrid_attr( 'post' ); ?>>
	...
	<div class="thumbnail-detail">
		...
		if (has_category( $categoryIdWorkshops, $post )) $titlePrefix = 'Workshop: ';
		?>
		<?php the_title( sprintf( '<h2 class="entry-title" ' . hybrid_get_attr( 'entry-title' ) . '><a href="%s" rel="bookmark" itemprop="url">' . $titlePrefix, esc_url( get_permalink() ) ), '</a></h2>' ); ?>
